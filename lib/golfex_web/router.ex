defmodule GolfexWeb.Router do
  ...
  import GolfexWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {GolfexWeb.Layouts, :root}
  ...
  if Application.compile_env(:golfex, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: GolfexWeb.Telemetry
