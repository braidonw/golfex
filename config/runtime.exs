...
#
#     PHX_SERVER=true bin/golfex start
#
...
if config_env() == :prod do
  ...
  config :golfex, Golfex.Repo, database: database_path
  ...
  config :golfex, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
